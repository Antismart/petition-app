...
pub struct CampaignInfo {
    /// The user has created the campaign.
    author: Identity,
...
impl CampaignInfo {
    ...
    ///# Arguments
    ///
    ///* 'asset': [ContractId] - the assets that this campaign accepts as a deposit.
    ///* 'author': [Identity] - The user who has created the campaign.
    ///* 'deadline': [u64] - The end time of campaign after which it becomes locked.
    ///
    ///# Returns
    ///
